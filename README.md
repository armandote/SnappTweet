...
Enjoy Tweet (Mac) for Twitter and let me know what you want to see next!

### Building Tweet (Mac)

Before Tweet (Mac) will work, you will need to generate some API keys, for Twitter. I will not be distributing my keys.
...
There are fields for the Twitter keys, as well as some third party services that Tweet (Mac) utilizes. You do not have to generate keys for the third party services. Those services just will not work.
